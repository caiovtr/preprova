...
export function LocationMapOrDest() {
    ...
    return (
        <View style={Painel.container}>
            <GooglePlacesAutocomplete
                ref={placesRef}
                styles={{ container: Painel.searchContainerOrigin, textInput: Painel.searchInput }}
                placeholder="Origem"
                fetchDetails={true}
            ...
            />
            <GooglePlacesAutocomplete
                styles={{ container: Painel.searchContainerDestination, textInput: Painel.searchInput }}
                placeholder="Destino"
                fetchDetails={true}
                GooglePlacesDetailsQuery={{ fields: "geometry" }}
                enablePoweredByContainer={false}
            ...
            />
            {!origin && <Text style={Painel.paragraph}>{text}</Text>}
            {origin && (
                <MapView style={Painel.map} region={origin}
